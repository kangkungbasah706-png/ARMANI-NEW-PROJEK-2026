              ...
              <div className="col-span-8 flex flex-col gap-5 h-full min-h-0">
                ...
                <div className="bg-white rounded-[24px] border border-black/10 shadow-lg p-4 flex flex-col flex-none min-h-0">
                   ...
                   <div className="mt-auto pt-4 border-t border-black/5 flex flex-col items-center justify-center shrink-0">
                      <div className="bg-black/[0.03] rounded-2xl px-8 py-1.5 border border-black/5 flex flex-col items-center shadow-inner relative overflow-hidden group">
                ...
                <div className="bg-[#1f2029] rounded-[24px] overflow-hidden shadow-2xl flex flex-col shrink-0 mt-6 mb-4">
                   <div className="p-4 flex flex-col gap-3">
                      ...
                      <button 
                        ...
                        className={`w-full flex items-center justify-center rounded-xl text-[26px] font-brand font-black uppercase italic tracking-[0.3em] transition-all active:scale-[0.98] leading-normal h-16
                          ${isDetailChecked 
